...
public class Ingredients {
    ...
    public Ingredients(String _id, String name, String type, double proteins, double fat, double carbohydrates, double calories,
    ...
    public ArrayList<Ingredients> getData() {
        return data;
    }
}
